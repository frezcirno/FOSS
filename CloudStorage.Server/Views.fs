        ...
        body [] [
            ...
            div [] [
                ...
                input [ _type "text"
                        _class "token"
                        _disabled ]
                button [ _onclick "signin()" ] [
                    str "刷新"
                ]
            ]
            div [] [
                a [ _href "/ping" ] [ str "ping pong" ]
            ]
            div [] [
                a [ _href "/time" ] [ str "时间" ]
            ]
            ...
            div [] [
                a [ _href "/file/upload/suc" ] [
                    str "文件上传成功"
                ]
            ]
            div [] [
                form [ _action "/file/upload"
                       _method "POST"
            ...
            div [] [
                button [ _onclick "window.location.replace('/file/query?');" ] [
                    str "近期文件查询"
                ]
            ]
            div [] [
                form [ _action "/file/update"
                       _method "POST" ] [
                    label [] [
                        str "文件hash:"
                        input [ _type "text"; _name "filehash" ]
